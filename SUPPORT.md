...
Thanks for using gridmaker! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/e-kotov/gridmaker/issues/new).
...
requests](https://github.com/e-kotov/gridmaker/issues) to make sure the

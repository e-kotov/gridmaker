...
::: callout-tip
Instead of downloading 2+ GB of Eurostat GISCO grid data, then extracting it for your region of interest, you can create grids on the fly with this package.
:::

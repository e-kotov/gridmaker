...
This outlines how to propose a change to gridmaker. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("e-kotov/gridmaker", fork = TRUE)`.
...
Please note that the gridmaker project is released with a [Contributor
Code of Conduct](http://www.ekotov.pro/gridmaker/CODE_OF_CONDUCT.md). By
